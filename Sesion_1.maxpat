...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 20.333332, 418.933319, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
,
					...
					"patching_rect" : [ 24.833332, 253.433319, 451.0, 139.400009 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-7::obj-21" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			"obj-6::obj-52" : [ "Level", "Level", 0 ],
			"obj-7::obj-41" : [ "number[5]", "number", 0 ],
			"obj-7::obj-94" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-7::obj-57" : [ "FreqMode[4]", "FreqMode", 0 ],
			"obj-6::obj-56" : [ "OutputChannel", "OutputChannel", 0 ],
			"obj-7::obj-109" : [ "pictctrl[2]", "pictctrl[1]", 0 ],
			"obj-7::obj-117" : [ "textbutton[11]", "textbutton[1]", 0 ],
			"obj-7::obj-7" : [ "live.toggle[1]", "live.toggle", 0 ],
			"obj-7::obj-113" : [ "pictctrl[1]", "pictctrl[1]", 0 ],
			"obj-7::obj-22" : [ "speed[5]", "speed", 0 ],
			"obj-6::obj-55" : [ "DSP", "DSP", 0 ],
			"obj-7::obj-67" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"obj-7::obj-1" : [ "multislider[2]", "multislider", 0 ],
			"obj-7::obj-30" : [ "pictctrl[4]", "pictctrl[1]", 0 ],
			"obj-7::obj-74" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-7::obj-10" : [ "smoothing[1]", "smoothing", 0 ],
			"obj-6::obj-22" : [ "Mute", "Mute", 0 ],
			"obj-7::obj-19" : [ "pictctrl[3]", "pictctrl[1]", 0 ],
			"obj-7::obj-85" : [ "number[4]", "number[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "cello-f2.aif",
